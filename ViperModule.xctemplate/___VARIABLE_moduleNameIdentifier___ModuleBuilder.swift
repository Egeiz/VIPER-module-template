...
class ___VARIABLE_moduleNameIdentifier___ModuleBuilder: NSObject {
    ...
    static func setup___VARIABLE_moduleNameIdentifier___Module(viewController: ___VARIABLE_moduleNameIdentifier___ViewController) {
        ...
        interactor.dataManager = ___VARIABLE_moduleNameIdentifier___DataManager()
        // Router
